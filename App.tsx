...
type AppMode = 'MENU' | 'COSTUME' | 'LYRICS';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
                ...
                >
                    ...
                    <p className="text-stone-500 leading-relaxed text-sm">
                        Drag and drop traditional costumes to match the opera archetypes. Test your knowledge of visual roles!
                    </p>
                </button>
                ...
                >
                    ...
                    <p className="text-stone-500 leading-relaxed text-sm">
                        Listen to the poetry. Match famous lyrics and quotes to their specific characters and plays.
                    </p>
                </button>
            </div>
        </div>
